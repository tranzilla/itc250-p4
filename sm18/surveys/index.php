 ...
 * 
 * @package nmPager
 * @author Ge Jin <jinge920119@gmail.com>
...
. 'sm18_' . "surveys s, " . 'sm18_' . "Admin a where s.AdminID=a.AdminID order by s.DateAdded desc
";
...
//         echo '</div>';
    ...
    echo "<div align=center>There is no survey yet. </div>";	
}
